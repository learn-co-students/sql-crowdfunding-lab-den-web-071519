...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) AS money_over_goal FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING money_over_goal >= 0;"
end
